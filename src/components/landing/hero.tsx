      ...
      <div className="pt-20 pb-24 sm:pt-20 sm:pb-32 lg:pb-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl bg-linear-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">
              Production-Ready SaaS Template
            </h1>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              A modern, open-source template for building SaaS applications with
              Next.js 16, Cloudflare Workers, and everything you need to launch
              quickly.
            </p>
